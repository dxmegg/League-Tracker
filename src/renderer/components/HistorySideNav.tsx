...
export function HistorySideNav({ scope }: { scope?: string }) {
  ...
  return (
    <nav className="w-[290px] shrink-0 max-[1199px]:hidden self-start">
      <div className="rounded-md border border-lol-border/50 bg-lol-card/30 overflow-hidden">
          ...
          return (
            <Fragment key={section}>
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  [
                    "block px-5 py-3.5 text-[14px] font-bold tracking-wider transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-lol-gold/60 focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--theme-bg-deep)]",
                    isActive
